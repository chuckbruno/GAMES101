                                      ...
                                      float zNear, float zFar)
{
    ...
    //                      0, 1 / height, 0, 0,
    //                      0, 0, 2 / (zFar- zNear), (-1) * (zNear + zFar) / (zFar- zNear),
    //                      0, 0, 0, 1;
 
    //// persp -> ortho -> screen
    //Eigen::Matrix4f ortho_to_persp_projection = Eigen::Matrix4f::Identity();
    //ortho_to_persp_projection << zNear, 0, 0, 0,
    //                      0, zNear, 0, 0,
    ...
    //projection = ortho_projection * ortho_to_persp_projection;
